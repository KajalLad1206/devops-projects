...
3. docker-compose file with volumes
    - https://github.com/KajalLad1206/devops-projects/blob/jenkins-job/Docker/project-1-nodejs-app-mongo/4-my-node-app-deploy-on-server-with-docker-volume/mongo.yaml
