...
1. create a file, 'Dockerfile' in your project's root directory
    - sample file: https://github.com/KajalLad1206/devops-projects/blob/jenkins-job/Docker/project-1-nodejs-app-mongo/1-my-node-app-build-image-locally/Dockerfile
