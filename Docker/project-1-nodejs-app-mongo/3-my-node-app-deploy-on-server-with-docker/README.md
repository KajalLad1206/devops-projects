...
1. docker-compose sample:
    - https://github.com/KajalLad1206/devops-projects/blob/jenkins-job/Docker/project-1-nodejs-app-mongo/3-my-node-app-deploy-on-server-with-docker/mongo.yaml
